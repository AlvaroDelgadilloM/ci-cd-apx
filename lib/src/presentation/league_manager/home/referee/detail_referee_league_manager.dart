...
import 'search_referee/cubit/referee_search_cubit.dart' as rf;
...
class DetailRefereeLeagueManager extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocListener<rf.RefereeSearchCubit, rf.RefereeSearchState>(
      listener: (context, state) {
        if (state.screenStatus == rf.ScreenStatus.success) {
                          ...
                          Expanded(
                            child: Padding(
                              ...
                              child: TextFormField(
                                ...
                                initialValue:
                                    state.refereeDetailDTO.refereeName,
                              ),
                            ),
                          ),
                          Expanded(
                            ...
                            child: TextFormField(
                              ...
                              style: TextStyle(fontSize: 13),
                              initialValue:
                                  state.refereeDetailDTO.refereeAddress,
                            ),
                          ))
                        ],
                      ),
