...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(48365668604797321205)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424555126283623090)
,p_page_template_id=>wwv_flow_imp.id(48365668604797321205)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424555577122623091)
,p_page_template_id=>wwv_flow_imp.id(48365668604797321205)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424556039020623091)
,p_page_template_id=>wwv_flow_imp.id(48365668604797321205)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424556538320623091)
,p_page_template_id=>wwv_flow_imp.id(48365668604797321205)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424557103708623092)
,p_page_template_id=>wwv_flow_imp.id(48365668604797321205)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424557577573623092)
,p_page_template_id=>wwv_flow_imp.id(48365668604797321205)
,p_name=>'Right Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424558092998623092)
,p_page_template_id=>wwv_flow_imp.id(48365668604797321205)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424558573940623092)
,p_page_template_id=>wwv_flow_imp.id(48365668604797321205)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424559043696623093)
,p_page_template_id=>wwv_flow_imp.id(48365668604797321205)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424559631290623093)
,p_page_template_id=>wwv_flow_imp.id(48365668604797321205)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424560097122623093)
,p_page_template_id=>wwv_flow_imp.id(48365668604797321205)
