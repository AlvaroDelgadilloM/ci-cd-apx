...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(48365654185315321196)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424502422495623053)
,p_page_template_id=>wwv_flow_imp.id(48365654185315321196)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424502849122623053)
,p_page_template_id=>wwv_flow_imp.id(48365654185315321196)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424503380546623054)
,p_page_template_id=>wwv_flow_imp.id(48365654185315321196)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424503875240623054)
,p_page_template_id=>wwv_flow_imp.id(48365654185315321196)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424504390043623054)
,p_page_template_id=>wwv_flow_imp.id(48365654185315321196)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424504894302623055)
,p_page_template_id=>wwv_flow_imp.id(48365654185315321196)
,p_name=>'Left Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424505370462623055)
,p_page_template_id=>wwv_flow_imp.id(48365654185315321196)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424505907032623055)
,p_page_template_id=>wwv_flow_imp.id(48365654185315321196)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424506399413623055)
,p_page_template_id=>wwv_flow_imp.id(48365654185315321196)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424506869460623056)
,p_page_template_id=>wwv_flow_imp.id(48365654185315321196)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424507400509623056)
,p_page_template_id=>wwv_flow_imp.id(48365654185315321196)
