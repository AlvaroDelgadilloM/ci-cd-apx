...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(48365670248689321206)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424571958874623102)
,p_page_template_id=>wwv_flow_imp.id(48365670248689321206)
,p_name=>'Wizard Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424572518249623102)
,p_page_template_id=>wwv_flow_imp.id(48365670248689321206)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424573006850623102)
,p_page_template_id=>wwv_flow_imp.id(48365670248689321206)
