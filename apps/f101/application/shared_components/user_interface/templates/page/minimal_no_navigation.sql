...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(48365667346782321204)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424541480272623080)
,p_page_template_id=>wwv_flow_imp.id(48365667346782321204)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424541964743623081)
,p_page_template_id=>wwv_flow_imp.id(48365667346782321204)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424542455477623081)
,p_page_template_id=>wwv_flow_imp.id(48365667346782321204)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424542943212623081)
,p_page_template_id=>wwv_flow_imp.id(48365667346782321204)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424543495450623082)
,p_page_template_id=>wwv_flow_imp.id(48365667346782321204)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424543933979623082)
,p_page_template_id=>wwv_flow_imp.id(48365667346782321204)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424544437090623082)
,p_page_template_id=>wwv_flow_imp.id(48365667346782321204)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424544973329623083)
,p_page_template_id=>wwv_flow_imp.id(48365667346782321204)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424545470400623083)
,p_page_template_id=>wwv_flow_imp.id(48365667346782321204)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424545989803623083)
,p_page_template_id=>wwv_flow_imp.id(48365667346782321204)
