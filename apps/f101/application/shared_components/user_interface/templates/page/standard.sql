...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(48365669522282321206)
,p_theme_id=>42
,p_name=>'Standard'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424565208334623097)
,p_page_template_id=>wwv_flow_imp.id(48365669522282321206)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424565665411623097)
,p_page_template_id=>wwv_flow_imp.id(48365669522282321206)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424566173274623098)
,p_page_template_id=>wwv_flow_imp.id(48365669522282321206)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424566700924623098)
,p_page_template_id=>wwv_flow_imp.id(48365669522282321206)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424567191468623098)
,p_page_template_id=>wwv_flow_imp.id(48365669522282321206)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424567695041623099)
,p_page_template_id=>wwv_flow_imp.id(48365669522282321206)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424568211973623099)
,p_page_template_id=>wwv_flow_imp.id(48365669522282321206)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424568671262623099)
,p_page_template_id=>wwv_flow_imp.id(48365669522282321206)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424569156465623099)
,p_page_template_id=>wwv_flow_imp.id(48365669522282321206)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424569717007623100)
,p_page_template_id=>wwv_flow_imp.id(48365669522282321206)
