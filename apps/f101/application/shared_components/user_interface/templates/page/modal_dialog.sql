...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(48365668198453321205)
,p_theme_id=>42
,p_name=>'Modal Dialog'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424548325338623085)
,p_page_template_id=>wwv_flow_imp.id(48365668198453321205)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424548810285623086)
,p_page_template_id=>wwv_flow_imp.id(48365668198453321205)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424549236646623086)
,p_page_template_id=>wwv_flow_imp.id(48365668198453321205)
