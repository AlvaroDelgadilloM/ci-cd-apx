...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(48365656097533321202)
,p_theme_id=>42
,p_name=>'Login'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424521463526623066)
,p_page_template_id=>wwv_flow_imp.id(48365656097533321202)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424521996583623066)
,p_page_template_id=>wwv_flow_imp.id(48365656097533321202)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424522457993623067)
,p_page_template_id=>wwv_flow_imp.id(48365656097533321202)
,p_name=>'Body Header'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424522952252623067)
,p_page_template_id=>wwv_flow_imp.id(48365656097533321202)
,p_name=>'Body Footer'
