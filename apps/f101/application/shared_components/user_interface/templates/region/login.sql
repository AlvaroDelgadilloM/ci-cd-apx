...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(48365680117128321218)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424740663405623234)
,p_plug_template_id=>wwv_flow_imp.id(48365680117128321218)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424741227089623235)
,p_plug_template_id=>wwv_flow_imp.id(48365680117128321218)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424741693658623235)
,p_plug_template_id=>wwv_flow_imp.id(48365680117128321218)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424742134554623235)
,p_plug_template_id=>wwv_flow_imp.id(48365680117128321218)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424742657708623236)
,p_plug_template_id=>wwv_flow_imp.id(48365680117128321218)
,p_name=>'Sub Regions'
