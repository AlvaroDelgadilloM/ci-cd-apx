...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(288578938654530517)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424710055871623211)
,p_plug_template_id=>wwv_flow_imp.id(288578938654530517)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424710591006623212)
,p_plug_template_id=>wwv_flow_imp.id(288578938654530517)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424711098952623212)
,p_plug_template_id=>wwv_flow_imp.id(288578938654530517)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424711589966623212)
,p_plug_template_id=>wwv_flow_imp.id(288578938654530517)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424712068527623213)
,p_plug_template_id=>wwv_flow_imp.id(288578938654530517)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424712534074623213)
,p_plug_template_id=>wwv_flow_imp.id(288578938654530517)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424713044288623213)
,p_plug_template_id=>wwv_flow_imp.id(288578938654530517)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424713620837623214)
,p_plug_template_id=>wwv_flow_imp.id(288578938654530517)
,p_name=>'Sub Regions'
