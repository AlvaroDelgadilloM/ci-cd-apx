...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(424798679965623279)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424799155814623280)
,p_plug_template_id=>wwv_flow_imp.id(424798679965623279)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424799684229623280)
,p_plug_template_id=>wwv_flow_imp.id(424798679965623279)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424800175566623281)
,p_plug_template_id=>wwv_flow_imp.id(424798679965623279)
,p_name=>'Sub Regions'
