...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(424802951282623282)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424803453858623283)
,p_plug_template_id=>wwv_flow_imp.id(424802951282623282)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424803960636623283)
,p_plug_template_id=>wwv_flow_imp.id(424802951282623282)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424804484104623283)
,p_plug_template_id=>wwv_flow_imp.id(424802951282623282)
,p_name=>'Button Start'
