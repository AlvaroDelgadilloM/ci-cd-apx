...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(48365682432962321220)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424774251398623262)
,p_plug_template_id=>wwv_flow_imp.id(48365682432962321220)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424774827558623262)
,p_plug_template_id=>wwv_flow_imp.id(48365682432962321220)
,p_name=>'Tabs'
