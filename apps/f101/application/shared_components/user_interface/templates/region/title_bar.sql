...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(48365683602117321221)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424783717567623269)
,p_plug_template_id=>wwv_flow_imp.id(48365683602117321221)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424784174831623269)
,p_plug_template_id=>wwv_flow_imp.id(48365683602117321221)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424784705986623270)
,p_plug_template_id=>wwv_flow_imp.id(48365683602117321221)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424785149038623270)
,p_plug_template_id=>wwv_flow_imp.id(48365683602117321221)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424785731796623270)
,p_plug_template_id=>wwv_flow_imp.id(48365683602117321221)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424786173107623270)
,p_plug_template_id=>wwv_flow_imp.id(48365683602117321221)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424786587218623271)
,p_plug_template_id=>wwv_flow_imp.id(48365683602117321221)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424787070739623271)
,p_plug_template_id=>wwv_flow_imp.id(48365683602117321221)
,p_name=>'Help'
,p_placeholder=>'HELP'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424787604656623271)
,p_plug_template_id=>wwv_flow_imp.id(48365683602117321221)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424788102809623272)
,p_plug_template_id=>wwv_flow_imp.id(48365683602117321221)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424788604722623272)
,p_plug_template_id=>wwv_flow_imp.id(48365683602117321221)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424789056933623272)
,p_plug_template_id=>wwv_flow_imp.id(48365683602117321221)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424789551844623273)
,p_plug_template_id=>wwv_flow_imp.id(48365683602117321221)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
