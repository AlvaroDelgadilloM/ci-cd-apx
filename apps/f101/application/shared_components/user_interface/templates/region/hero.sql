...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(48365678642084321217)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424675549753623182)
,p_plug_template_id=>wwv_flow_imp.id(48365678642084321217)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424676117979623182)
,p_plug_template_id=>wwv_flow_imp.id(48365678642084321217)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424676627108623183)
,p_plug_template_id=>wwv_flow_imp.id(48365678642084321217)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424677103726623183)
,p_plug_template_id=>wwv_flow_imp.id(48365678642084321217)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424677534731623183)
,p_plug_template_id=>wwv_flow_imp.id(48365678642084321217)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
