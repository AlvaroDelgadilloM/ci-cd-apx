...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(534895733108980813)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424683080461623187)
,p_plug_template_id=>wwv_flow_imp.id(534895733108980813)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424683544869623188)
,p_plug_template_id=>wwv_flow_imp.id(534895733108980813)
,p_name=>'Sub Regions'
