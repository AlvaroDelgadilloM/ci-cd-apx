...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(48365676559510321216)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424638864853623153)
,p_plug_template_id=>wwv_flow_imp.id(48365676559510321216)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424639398461623153)
,p_plug_template_id=>wwv_flow_imp.id(48365676559510321216)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424639880590623153)
,p_plug_template_id=>wwv_flow_imp.id(48365676559510321216)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424640390666623154)
,p_plug_template_id=>wwv_flow_imp.id(48365676559510321216)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424640885366623154)
,p_plug_template_id=>wwv_flow_imp.id(48365676559510321216)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424641409814623154)
,p_plug_template_id=>wwv_flow_imp.id(48365676559510321216)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424641899379623154)
,p_plug_template_id=>wwv_flow_imp.id(48365676559510321216)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424642347646623155)
,p_plug_template_id=>wwv_flow_imp.id(48365676559510321216)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424642916204623155)
,p_plug_template_id=>wwv_flow_imp.id(48365676559510321216)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424643373617623155)
,p_plug_template_id=>wwv_flow_imp.id(48365676559510321216)
,p_name=>'Sub Regions'
