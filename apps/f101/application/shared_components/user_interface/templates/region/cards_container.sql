...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(708670279894837319)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424607099062623128)
,p_plug_template_id=>wwv_flow_imp.id(708670279894837319)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424607567018623128)
,p_plug_template_id=>wwv_flow_imp.id(708670279894837319)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(424608086891623129)
,p_plug_template_id=>wwv_flow_imp.id(708670279894837319)
,p_name=>'Sub Regions'
