...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(424929533119623393)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(424939570903623400)
,p_plugin_id=>wwv_flow_imp.id(424929533119623393)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(424940078612623401)
,p_plugin_attribute_id=>wwv_flow_imp.id(424939570903623400)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'IMAGE'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(424940665125623401)
,p_plugin_attribute_id=>wwv_flow_imp.id(424939570903623400)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(424941282048623401)
,p_plugin_attribute_id=>wwv_flow_imp.id(424939570903623400)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(424931086443623395)
,p_plugin_id=>wwv_flow_imp.id(424929533119623393)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(424939570903623400)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(424931538496623395)
,p_plugin_id=>wwv_flow_imp.id(424929533119623393)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(424931086443623395)
,p_depending_on_has_to_exist=>true
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(424932083414623395)
,p_plugin_id=>wwv_flow_imp.id(424929533119623393)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(424930532554623394)
,p_plugin_id=>wwv_flow_imp.id(424929533119623393)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(424932563577623396)
,p_plugin_id=>wwv_flow_imp.id(424929533119623393)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(424933058780623396)
,p_plugin_attribute_id=>wwv_flow_imp.id(424932563577623396)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(424933680906623396)
,p_plugin_attribute_id=>wwv_flow_imp.id(424932563577623396)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(424934294366623397)
,p_plugin_attribute_id=>wwv_flow_imp.id(424932563577623396)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(424934862487623397)
,p_plugin_id=>wwv_flow_imp.id(424929533119623393)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(424935367528623398)
,p_plugin_attribute_id=>wwv_flow_imp.id(424934862487623397)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(424935951218623398)
,p_plugin_attribute_id=>wwv_flow_imp.id(424934862487623397)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(424936541353623398)
,p_plugin_attribute_id=>wwv_flow_imp.id(424934862487623397)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(424937228275623399)
,p_plugin_attribute_id=>wwv_flow_imp.id(424934862487623397)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(424937801333623399)
,p_plugin_attribute_id=>wwv_flow_imp.id(424934862487623397)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(424938427534623399)
,p_plugin_attribute_id=>wwv_flow_imp.id(424934862487623397)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(424938992906623400)
,p_plugin_attribute_id=>wwv_flow_imp.id(424934862487623397)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(424930049589623394)
,p_plugin_id=>wwv_flow_imp.id(424929533119623393)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2224980660758737146)
,p_plugin_id=>wwv_flow_imp.id(424929533119623393)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
