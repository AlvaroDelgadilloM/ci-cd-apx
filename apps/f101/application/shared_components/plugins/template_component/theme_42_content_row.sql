...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(425000528232623447)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2352238459874695142)
,p_plugin_id=>wwv_flow_imp.id(425000528232623447)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2352237904862695141)
,p_plugin_id=>wwv_flow_imp.id(425000528232623447)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(425027835250623465)
,p_plugin_id=>wwv_flow_imp.id(425000528232623447)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(425028361620623465)
,p_plugin_id=>wwv_flow_imp.id(425000528232623447)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(425025912333623464)
,p_plugin_id=>wwv_flow_imp.id(425000528232623447)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(425027336452623465)
,p_plugin_id=>wwv_flow_imp.id(425000528232623447)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(425026430374623464)
,p_plugin_id=>wwv_flow_imp.id(425000528232623447)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(425026896039623464)
,p_plugin_id=>wwv_flow_imp.id(425000528232623447)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(425011896663623454)
,p_plugin_id=>wwv_flow_imp.id(425000528232623447)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(425026430374623464)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(2352238459874695142)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(425012355542623455)
,p_plugin_attribute_id=>wwv_flow_imp.id(425011896663623454)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(425013011144623455)
,p_plugin_attribute_id=>wwv_flow_imp.id(425011896663623454)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(425013540747623456)
,p_plugin_attribute_id=>wwv_flow_imp.id(425011896663623454)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(425002817420623449)
,p_plugin_id=>wwv_flow_imp.id(425000528232623447)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(425011896663623454)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(425003298188623449)
,p_plugin_id=>wwv_flow_imp.id(425000528232623447)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(425002817420623449)
,p_depending_on_has_to_exist=>true
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(425003820675623449)
,p_plugin_id=>wwv_flow_imp.id(425000528232623447)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(425002296665623448)
,p_plugin_id=>wwv_flow_imp.id(425000528232623447)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(425004291857623450)
,p_plugin_id=>wwv_flow_imp.id(425000528232623447)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(425004774150623450)
,p_plugin_attribute_id=>wwv_flow_imp.id(425004291857623450)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(425005424301623450)
,p_plugin_attribute_id=>wwv_flow_imp.id(425004291857623450)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(425005951619623451)
,p_plugin_attribute_id=>wwv_flow_imp.id(425004291857623450)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(425006580878623451)
,p_plugin_attribute_id=>wwv_flow_imp.id(425004291857623450)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(425017619226623458)
,p_plugin_id=>wwv_flow_imp.id(425000528232623447)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(425026896039623464)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(2352237904862695141)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(425025361877623463)
,p_plugin_id=>wwv_flow_imp.id(425000528232623447)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(425023154354623462)
,p_plugin_id=>wwv_flow_imp.id(425000528232623447)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(425017075235623458)
,p_plugin_id=>wwv_flow_imp.id(425000528232623447)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(425018056783623458)
,p_plugin_id=>wwv_flow_imp.id(425000528232623447)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(425023707456623462)
,p_plugin_id=>wwv_flow_imp.id(425000528232623447)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(425024183252623463)
,p_plugin_attribute_id=>wwv_flow_imp.id(425023707456623462)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(425024756366623463)
,p_plugin_attribute_id=>wwv_flow_imp.id(425023707456623462)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(425018559754623459)
,p_plugin_id=>wwv_flow_imp.id(425000528232623447)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(425019035790623459)
,p_plugin_attribute_id=>wwv_flow_imp.id(425018559754623459)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(425019708545623460)
,p_plugin_attribute_id=>wwv_flow_imp.id(425018559754623459)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(425020249137623460)
,p_plugin_attribute_id=>wwv_flow_imp.id(425018559754623459)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(425007224923623452)
,p_plugin_id=>wwv_flow_imp.id(425000528232623447)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(425007677920623452)
,p_plugin_attribute_id=>wwv_flow_imp.id(425007224923623452)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(425008255744623452)
,p_plugin_attribute_id=>wwv_flow_imp.id(425007224923623452)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(425008838226623453)
,p_plugin_attribute_id=>wwv_flow_imp.id(425007224923623452)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(425009442193623453)
,p_plugin_attribute_id=>wwv_flow_imp.id(425007224923623452)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(425010094492623453)
,p_plugin_attribute_id=>wwv_flow_imp.id(425007224923623452)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(425010719635623454)
,p_plugin_attribute_id=>wwv_flow_imp.id(425007224923623452)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(425011278662623454)
,p_plugin_attribute_id=>wwv_flow_imp.id(425007224923623452)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(425020870023623460)
,p_plugin_id=>wwv_flow_imp.id(425000528232623447)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(425021344477623461)
,p_plugin_attribute_id=>wwv_flow_imp.id(425020870023623460)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-Badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(425022014354623461)
,p_plugin_attribute_id=>wwv_flow_imp.id(425020870023623460)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(425022567711623461)
,p_plugin_attribute_id=>wwv_flow_imp.id(425020870023623460)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(425014148517623456)
,p_plugin_id=>wwv_flow_imp.id(425000528232623447)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(425014643437623456)
,p_plugin_attribute_id=>wwv_flow_imp.id(425014148517623456)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-ContentRow-badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(425015309411623457)
,p_plugin_attribute_id=>wwv_flow_imp.id(425014148517623456)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(425015925392623457)
,p_plugin_attribute_id=>wwv_flow_imp.id(425014148517623456)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(425016434858623457)
,p_plugin_attribute_id=>wwv_flow_imp.id(425014148517623456)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(425001778991623448)
,p_plugin_id=>wwv_flow_imp.id(425000528232623447)
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(2233452350090516756)
,p_plugin_id=>wwv_flow_imp.id(425000528232623447)
,p_name=>'Button'
,p_type=>'BUTTON'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(2233453609610520904)
,p_plugin_id=>wwv_flow_imp.id(425000528232623447)
,p_name=>'Menu'
,p_type=>'MENU'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2219858721416110023)
,p_plugin_id=>wwv_flow_imp.id(425000528232623447)
,p_name=>'Title Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2220538022146193127)
,p_plugin_id=>wwv_flow_imp.id(425000528232623447)
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2233450415023471770)
,p_plugin_id=>wwv_flow_imp.id(425000528232623447)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2233451748413485627)
,p_plugin_id=>wwv_flow_imp.id(425000528232623447)
