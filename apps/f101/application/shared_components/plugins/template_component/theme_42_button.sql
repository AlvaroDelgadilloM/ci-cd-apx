...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(424969985989623424)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(424973023236623426)
,p_plugin_id=>wwv_flow_imp.id(424969985989623424)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(424973947671623426)
,p_plugin_id=>wwv_flow_imp.id(424969985989623424)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(424973495755623426)
,p_plugin_id=>wwv_flow_imp.id(424969985989623424)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(424970976070623424)
,p_plugin_id=>wwv_flow_imp.id(424969985989623424)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(424970441164623424)
,p_plugin_id=>wwv_flow_imp.id(424969985989623424)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(424971501980623425)
,p_plugin_id=>wwv_flow_imp.id(424969985989623424)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(424971936706623425)
,p_plugin_id=>wwv_flow_imp.id(424969985989623424)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(424972482106623425)
,p_plugin_id=>wwv_flow_imp.id(424969985989623424)
,p_attribute_scope=>'COMPONENT'
