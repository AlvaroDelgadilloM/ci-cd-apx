...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(424974460636623428)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2572057631165730379)
,p_plugin_id=>wwv_flow_imp.id(424974460636623428)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2572058186177730380)
,p_plugin_id=>wwv_flow_imp.id(424974460636623428)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(424993532267623441)
,p_plugin_id=>wwv_flow_imp.id(424974460636623428)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(424989944924623438)
,p_plugin_id=>wwv_flow_imp.id(424974460636623428)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(424993075764623440)
,p_plugin_id=>wwv_flow_imp.id(424974460636623428)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(424990478104623438)
,p_plugin_id=>wwv_flow_imp.id(424974460636623428)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(424991020198623439)
,p_plugin_id=>wwv_flow_imp.id(424974460636623428)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(424991491448623439)
,p_plugin_id=>wwv_flow_imp.id(424974460636623428)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(424981154065623432)
,p_plugin_id=>wwv_flow_imp.id(424974460636623428)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(424991020198623439)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(2572058186177730380)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(424981669678623433)
,p_plugin_attribute_id=>wwv_flow_imp.id(424981154065623432)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(424982282205623433)
,p_plugin_attribute_id=>wwv_flow_imp.id(424981154065623432)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(424982881627623433)
,p_plugin_attribute_id=>wwv_flow_imp.id(424981154065623432)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(424976768202623429)
,p_plugin_id=>wwv_flow_imp.id(424974460636623428)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(424981154065623432)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(424977265537623430)
,p_plugin_id=>wwv_flow_imp.id(424974460636623428)
,p_attribute_scope=>'COMPONENT'
...
,p_depending_on_attribute_id=>wwv_flow_imp.id(424976768202623429)
,p_depending_on_has_to_exist=>true
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(424977783318623430)
,p_plugin_id=>wwv_flow_imp.id(424974460636623428)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(424976265056623429)
,p_plugin_id=>wwv_flow_imp.id(424974460636623428)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(424978239059623430)
,p_plugin_id=>wwv_flow_imp.id(424974460636623428)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(424978734981623431)
,p_plugin_attribute_id=>wwv_flow_imp.id(424978239059623430)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(424979420852623431)
,p_plugin_attribute_id=>wwv_flow_imp.id(424978239059623430)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(424980025254623431)
,p_plugin_attribute_id=>wwv_flow_imp.id(424978239059623430)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(424980627518623432)
,p_plugin_attribute_id=>wwv_flow_imp.id(424978239059623430)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(424984004343623434)
,p_plugin_id=>wwv_flow_imp.id(424974460636623428)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(424991491448623439)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(2572057631165730379)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(424989467611623438)
,p_plugin_id=>wwv_flow_imp.id(424974460636623428)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(424987328379623436)
,p_plugin_id=>wwv_flow_imp.id(424974460636623428)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(424983500903623434)
,p_plugin_id=>wwv_flow_imp.id(424974460636623428)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(424984470012623435)
,p_plugin_id=>wwv_flow_imp.id(424974460636623428)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(424987809544623437)
,p_plugin_id=>wwv_flow_imp.id(424974460636623428)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(424988314730623437)
,p_plugin_attribute_id=>wwv_flow_imp.id(424987809544623437)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(424988867108623437)
,p_plugin_attribute_id=>wwv_flow_imp.id(424987809544623437)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(424984960909623435)
,p_plugin_id=>wwv_flow_imp.id(424974460636623428)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(424985457194623435)
,p_plugin_attribute_id=>wwv_flow_imp.id(424984960909623435)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(424986112294623436)
,p_plugin_attribute_id=>wwv_flow_imp.id(424984960909623435)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(424986632303623436)
,p_plugin_attribute_id=>wwv_flow_imp.id(424984960909623435)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(424991947163623439)
,p_plugin_id=>wwv_flow_imp.id(424974460636623428)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(424992487371623440)
,p_plugin_attribute_id=>wwv_flow_imp.id(424991947163623439)
,p_display_sequence=>10
,p_display_value=>'Compact'
,p_return_value=>'t-Timeline--compact'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(424975809399623429)
,p_plugin_id=>wwv_flow_imp.id(424974460636623428)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2219827531363938966)
,p_plugin_id=>wwv_flow_imp.id(424974460636623428)
,p_name=>'Title Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2334238894352202567)
,p_plugin_id=>wwv_flow_imp.id(424974460636623428)
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2453270141326507008)
,p_plugin_id=>wwv_flow_imp.id(424974460636623428)
,p_name=>'Avatar Link'
