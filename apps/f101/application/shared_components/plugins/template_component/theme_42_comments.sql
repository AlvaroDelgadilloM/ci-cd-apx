...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(424953213503623411)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2224838864813655127)
,p_plugin_id=>wwv_flow_imp.id(424953213503623411)
,p_title=>'Avatar'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(424962756058623418)
,p_plugin_id=>wwv_flow_imp.id(424953213503623411)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(424965503808623419)
,p_plugin_id=>wwv_flow_imp.id(424953213503623411)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(424962235105623417)
,p_plugin_id=>wwv_flow_imp.id(424953213503623411)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(424954631279623412)
,p_plugin_id=>wwv_flow_imp.id(424953213503623411)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(424960012036623416)
,p_plugin_id=>wwv_flow_imp.id(424953213503623411)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(424963282530623418)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(2224838864813655127)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(424960452773623416)
,p_plugin_attribute_id=>wwv_flow_imp.id(424960012036623416)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(424961080663623416)
,p_plugin_attribute_id=>wwv_flow_imp.id(424960012036623416)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(424961650853623417)
,p_plugin_attribute_id=>wwv_flow_imp.id(424960012036623416)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(424955578612623413)
,p_plugin_id=>wwv_flow_imp.id(424953213503623411)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(424960012036623416)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(424956108822623413)
,p_plugin_id=>wwv_flow_imp.id(424953213503623411)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(424955578612623413)
,p_depending_on_has_to_exist=>true
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(424956631056623414)
,p_plugin_id=>wwv_flow_imp.id(424953213503623411)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(424955083172623413)
,p_plugin_id=>wwv_flow_imp.id(424953213503623411)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(424957068919623414)
,p_plugin_id=>wwv_flow_imp.id(424953213503623411)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(424957557475623414)
,p_plugin_attribute_id=>wwv_flow_imp.id(424957068919623414)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(424958191009623415)
,p_plugin_attribute_id=>wwv_flow_imp.id(424957068919623414)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(424958777357623415)
,p_plugin_attribute_id=>wwv_flow_imp.id(424957068919623414)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(424959385896623415)
,p_plugin_attribute_id=>wwv_flow_imp.id(424957068919623414)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(424963282530623418)
,p_plugin_id=>wwv_flow_imp.id(424953213503623411)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(424963775257623418)
,p_plugin_id=>wwv_flow_imp.id(424953213503623411)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(424964321190623419)
,p_plugin_attribute_id=>wwv_flow_imp.id(424963775257623418)
,p_display_sequence=>10
,p_display_value=>'Basic'
,p_return_value=>'t-Comments--basic'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(424964912611623419)
,p_plugin_attribute_id=>wwv_flow_imp.id(424963775257623418)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(424954106098623412)
,p_plugin_id=>wwv_flow_imp.id(424953213503623411)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(2224971532246756630)
,p_plugin_id=>wwv_flow_imp.id(424953213503623411)
,p_name=>'Link'
,p_type=>'BUTTON'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2224970940741749173)
,p_plugin_id=>wwv_flow_imp.id(424953213503623411)
,p_name=>'Actions'
,p_static_id=>'ACTIONS'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2225026564411731052)
,p_plugin_id=>wwv_flow_imp.id(424953213503623411)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2225178782124601823)
,p_plugin_id=>wwv_flow_imp.id(424953213503623411)
