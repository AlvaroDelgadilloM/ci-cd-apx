...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(425037547153623474)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2225055564944507122)
,p_plugin_id=>wwv_flow_imp.id(425037547153623474)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2225056119956507123)
,p_plugin_id=>wwv_flow_imp.id(425037547153623474)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(425059132578623488)
,p_plugin_id=>wwv_flow_imp.id(425037547153623474)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(425053081170623484)
,p_plugin_id=>wwv_flow_imp.id(425037547153623474)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(425053538932623485)
,p_plugin_id=>wwv_flow_imp.id(425037547153623474)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(425054059586623485)
,p_plugin_id=>wwv_flow_imp.id(425037547153623474)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(425044243276623479)
,p_plugin_id=>wwv_flow_imp.id(425037547153623474)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(425053538932623485)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(2225056119956507123)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(425044743796623479)
,p_plugin_attribute_id=>wwv_flow_imp.id(425044243276623479)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(425045380392623479)
,p_plugin_attribute_id=>wwv_flow_imp.id(425044243276623479)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(425045984848623480)
,p_plugin_attribute_id=>wwv_flow_imp.id(425044243276623479)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(425039915283623476)
,p_plugin_id=>wwv_flow_imp.id(425037547153623474)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(425044243276623479)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(425040406713623476)
,p_plugin_id=>wwv_flow_imp.id(425037547153623474)
,p_attribute_scope=>'COMPONENT'
...
,p_depending_on_attribute_id=>wwv_flow_imp.id(425039915283623476)
,p_depending_on_has_to_exist=>true
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(425040893945623476)
,p_plugin_id=>wwv_flow_imp.id(425037547153623474)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(425039336304623475)
,p_plugin_id=>wwv_flow_imp.id(425037547153623474)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(425041382083623477)
,p_plugin_id=>wwv_flow_imp.id(425037547153623474)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(425041867363623477)
,p_plugin_attribute_id=>wwv_flow_imp.id(425041382083623477)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(425042492774623477)
,p_plugin_attribute_id=>wwv_flow_imp.id(425041382083623477)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(425043076065623478)
,p_plugin_attribute_id=>wwv_flow_imp.id(425041382083623477)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(425043662761623478)
,p_plugin_attribute_id=>wwv_flow_imp.id(425041382083623477)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(425047114622623480)
,p_plugin_id=>wwv_flow_imp.id(425037547153623474)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(425054059586623485)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(2225055564944507122)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(425052631587623484)
,p_plugin_id=>wwv_flow_imp.id(425037547153623474)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(425050417802623483)
,p_plugin_id=>wwv_flow_imp.id(425037547153623474)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(425046600581623480)
,p_plugin_id=>wwv_flow_imp.id(425037547153623474)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(425047533916623481)
,p_plugin_id=>wwv_flow_imp.id(425037547153623474)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(425050863266623483)
,p_plugin_id=>wwv_flow_imp.id(425037547153623474)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(425051332134623483)
,p_plugin_attribute_id=>wwv_flow_imp.id(425050863266623483)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(425051943091623484)
,p_plugin_attribute_id=>wwv_flow_imp.id(425050863266623483)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(425048091214623481)
,p_plugin_id=>wwv_flow_imp.id(425037547153623474)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(425048534085623481)
,p_plugin_attribute_id=>wwv_flow_imp.id(425048091214623481)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(425049196672623482)
,p_plugin_attribute_id=>wwv_flow_imp.id(425048091214623481)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(425049754687623482)
,p_plugin_attribute_id=>wwv_flow_imp.id(425048091214623481)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(425054580478623485)
,p_plugin_id=>wwv_flow_imp.id(425037547153623474)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(425055127998623486)
,p_plugin_attribute_id=>wwv_flow_imp.id(425054580478623485)
,p_display_sequence=>10
,p_display_value=>'2 Column Grid'
,p_return_value=>'t-MediaList--cols t-MediaList--2cols'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(425055674858623486)
,p_plugin_attribute_id=>wwv_flow_imp.id(425054580478623485)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(425056330939623486)
,p_plugin_attribute_id=>wwv_flow_imp.id(425054580478623485)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(425056926159623487)
,p_plugin_attribute_id=>wwv_flow_imp.id(425054580478623485)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(425057530608623487)
,p_plugin_attribute_id=>wwv_flow_imp.id(425054580478623485)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(425058039291623488)
,p_plugin_id=>wwv_flow_imp.id(425037547153623474)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(425058623181623488)
,p_plugin_attribute_id=>wwv_flow_imp.id(425058039291623488)
,p_display_sequence=>10
,p_display_value=>'Large'
,p_return_value=>'t-MediaList--large force-fa-lg'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(425038861984623475)
,p_plugin_id=>wwv_flow_imp.id(425037547153623474)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2225259172113653751)
,p_plugin_id=>wwv_flow_imp.id(425037547153623474)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
