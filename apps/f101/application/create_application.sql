...
,p_owner=>nvl(wwv_flow_application_install.get_schema,'WKSP_ADMCI')
...
,p_application_group=>wwv_flow_imp.id(8591002849004268)
...
,p_checksum_salt_last_reset=>'20230511192817'
...
,p_authentication_id=>wwv_flow_imp.id(48365706655767321270)
